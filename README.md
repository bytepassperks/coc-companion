...
- Screenshot import is available at `POST /api/ocr/:tag` for best-effort vision drafts of upgrades, builders, armies, hero loadouts, and ores. OCR is advisory only: the dashboard always shows an editable review and never saves extracted values automatically.
